...
#                     config_ = ('-l eng --oem 1 --psm 3')
#                     text = pytesseract.image_to_string(plate_im, lang='en',config= config_)
#                     return text
#
#
#
...
# # cv2.imshow("Image of car ",img)
# # cv2.waitKey()
# # cv2.destroyAllWindows()
#
#
# number_plate=number_plate_detection("C:/Users/rakes/Desktop/Automatic-Number-plate-detection-for-Indian-vehicles-main/Dataset/1.jpeg")
...
#
#
# # for img in glob.glob(dir+"/Number_plate/*.png") :
#
#
#
#
...
def number_plate_detection(img):
    ...
    config_ = ('-l eng --oem 1 --psm 3')
    text = pytesseract.image_to_string(img, lang='en',config=config_)
    if len(text) != 0:
        return text
    else:
        return  None
